...
if TSP_SIZE == 20:
    ...
    REF = torch.tensor([35, 35])
elif TSP_SIZE == 100:
    REF = torch.tensor([65, 65])
elif TSP_SIZE == 150:
    REF = torch.tensor([85, 85])
elif TSP_SIZE == 200:
    REF = torch.tensor([115, 115])
else:
    raise NotImplementedError

MODE = 2  # 1 denotes Train, 2 denotes Test, 3 denotes Save Submodels, 4 denotes Load Submodels to Test
METHOD = 'NHDE-M'
SAVE_INTVL = 1
