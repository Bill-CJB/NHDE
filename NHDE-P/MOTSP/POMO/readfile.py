...
def main(problem_size, data_dir, aug_data_dir):
    ...
    print(f"MO{PROBLEM}{problem_size} Aug:{aug_factor} ", 'HV Ratio: {:.4f}'.format(hvs.mean()),
          f" Ref Point:[{ref[0]},{ref[1]}]")
...
if __name__ == "__main__":
    # data_dir = "20220715_150528_test__tsp_n20"
    # aug_data_dir = "20220715_150222_test__tsp_n20"
    # main(20, data_dir, aug_data_dir)
    # data_dir = "20220715_151145_test__tsp_n50"
    # aug_data_dir = "20220715_151445_test__tsp_n50"
    # main(50, data_dir, aug_data_dir)
    # data_dir = "20220715_152604_test__tsp_n100"
    # aug_data_dir = "20220715_152840_test__tsp_n100"
    # main(100, data_dir, aug_data_dir)
    data_dir = "20220801_171909_test__tsp_n20"
    aug_data_dir = "20220801_171914_test__tsp_n20"
    main(20, data_dir, aug_data_dir)
    data_dir = "20220801_111358_test__tsp_n50"
    aug_data_dir = "20220801_111404_test__tsp_n50"
    main(50, data_dir, aug_data_dir)
    data_dir = "20220731_233826_test__tsp_n100"
    aug_data_dir = "20220731_234052_test__tsp_n100"
    main(100, data_dir, aug_data_dir)
    #
    # data_dir = ""
    # aug_data_dir = ""
